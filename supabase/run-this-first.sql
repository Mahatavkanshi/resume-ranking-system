-- Resume Ranking System database setup
-- Run this whole file once in Supabase SQL Editor.
-- It fixes:
-- 1. recruiter role saving
-- 2. recruiter job post creation
-- 3. student/candidate visibility for open recruiter posts
...
begin
  ...
  if auth.uid() is null then
    raise exception 'You must be signed in to switch roles';
  end if;
